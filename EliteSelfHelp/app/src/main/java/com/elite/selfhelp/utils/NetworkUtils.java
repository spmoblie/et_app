...
public class NetworkUtils {
    ...
    public static boolean isNetworkAvailable() {
        ConnectivityManager cm = (ConnectivityManager) AppApplication.getInstance()
    ...
    public static boolean isGpsEnabled() {
        LocationManager lm = ((LocationManager) AppApplication.getInstance()
    ...
    /**
     * 判断当前网络是否是wifi网络
     * if(info.getType()==ConnectivityManager.TYPE_MOBILE) { //判断3G网
     */
