...
import com.elite.selfhelp.utils.NetworkUtils;
    ...
    private static final Interceptor sLoggingInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (request.body() != null) {
                ...
                LogUtils.i("Retrofit", "request.body() is null");
            }
            //打印Path信息
            LogUtils.i("Retrofit", "Path : " + request.url() + (request.body() != null ? "?" + _parseParams(request.body(), requestBuffer) : ""));
            Response response = chain.proceed(request);
            MediaType mediaType = response.body().contentType();
            //打印Body信息
            String body = response.body().string();
            LogUtils.i("Retrofit", "Body : " + body);
    ...
    private static final Interceptor sRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetworkUtils.isNetworkAvailable()) {
                ...
                LogUtils.i("Retrofit", "no network");
            }
