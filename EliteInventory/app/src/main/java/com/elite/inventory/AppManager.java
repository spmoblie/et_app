...
import com.elite.inventory.utils.CleanCacheUtils;
...
public class AppManager {
    ...
    public void AppExit(Context context) {
        try {
            //清除临时缓存
            CleanCacheUtils.cleanAppTemporaryData(context);
            killAllActivity();
...
//        CleanCacheUtils.cleanCustomCache(AppConfig.SAVE_PATH_TXT_SAVE + AppConfig.cookiesFileName);
