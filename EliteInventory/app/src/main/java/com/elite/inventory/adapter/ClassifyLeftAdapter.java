...
public class ClassifyLeftAdapter extends RecyclerView.Adapter<ClassifyLeftAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        // 绑定数据到ViewHolder
        viewHolder.mTV_1.setText(data.getClassName());
        if (index == pos) {
            viewHolder.mTV_1.setTextColor(mContext.getResources().getColor(R.color.text_color_white, null));
            viewHolder.mTV_1.setBackgroundColor(mContext.getResources().getColor(R.color.back_color_state, null));
        }else {
            viewHolder.mTV_1.setTextColor(mContext.getResources().getColor(R.color.text_color_state, null));
            viewHolder.mTV_1.setBackgroundColor(mContext.getResources().getColor(R.color.back_color_block, null));
        }
