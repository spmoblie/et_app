...
public class GoodsDBService {
    ...
    public List<GoodsEntity> getListData(int categoryId) {
        SQLiteDatabase db = dbOpenHelper.getReadableDatabase();
        Cursor cursor = db.query(TABLE_NAME, null, NAME_02 + "=?", new String[] { String.valueOf(categoryId) }, null, null, null, null);
        try {
